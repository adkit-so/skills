...
Use this knowledge to help the user understand Meta advertising before they start creating ads. If the user asks whether Meta is right for them, use the comparison below to guide them. If they're already committed to Meta, skip straight to what matters: creative quality and how the auction works.

## Agent Decision Tree

- **"Should I use Facebook or Google ads?"** — Ask: *What's your product? Is your audience actively searching for it, or do they not know it exists yet?* Then use the interruption vs search comparison below.
- **"Is Meta worth it for my budget?"** — Reframe: budget matters less than creative quality on Meta. A $500/month account with great ads beats a $5,000/month account with mediocre ones. Explain the auction formula below.
...
Search volume is not your market size. It measures existing awareness, not potential demand.

```
Total market  >>>  People aware a solution exists  >>>  People actively searching
```

Meta's strength is reaching the left side of this funnel — people who would buy but aren't searching.

When a user underestimates their market size, use this framing. Most founders anchor on keyword search volume and miss the bigger picture.
...
This is directly from Meta's documentation — not speculation.
...
Summarize these for the user when wrapping up a fundamentals discussion:

- Meta is interruption marketing — you must earn attention with compelling creative
- The auction rewards ad quality, not just budget
- Your real market is far larger than search volume suggests
- Creative quality is the highest-leverage cost lever
- Broad targeting + strong creative + Pixel data = Meta's current best practice

## With AdKit

If you're using AdKit, run `npx adkit manage --help` to see available commands for managing Meta campaigns.
